...
class Enfermero(Trabajador):
    ...
    def atender(self, paciente, consultas):
        '''
        Realiza las operaciones de trasladar de la lista de espera a la consulta disponible al paciente que se le indique.
        ...
        for consulta in consultas:
            if len(consulta.paciente) == 0:
                print(f'La consulta {consulta.numero} esta libre.')
